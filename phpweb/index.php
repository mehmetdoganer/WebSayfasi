...
<div style="position: fixed; top: 150px; left:350px; width: 1300px; height:600px;"></p><br>
</div>
<div style="position:fixed; left:30%; top:30%; margin-left: -50px; margin-top:-30px;">
<a class="twitter-timeline" href="https://twitter.com/Haber?ref_src=twsrc" width="350" height="400" frameborder="0" scrolling="no">>Tweets by haber</a> <script  async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
</div>
<div style="position:fixed; left:70%; top:30%; margin-left: -300px; margin-top:-30px;">
<iframe src="https://onedrive.live.com/embed?cid=08FCEC0A1EDE15DA&resid=8FCEC0A1EDE15DA%21111&authkey=AJN2HiPaH7_VeqQ&em=2" width="650" height="400" frameborder="0" scrolling="no"></iframe></div>
